...
Allows to create the tables Marco needs to apply to his rasters the urban,
 motorway and non urban shares.

Inputs:
    # define aggregation list (see excel file EMISSIONS_comparisonWithMarco_v2
    for definitions)
    shares_lst=[1, 2, 3, 4, 5, 6, 7, 8]
    # pollutants of interest in TREMOVE:
    pollutant_lst =  ['CO','NOx','VOC', 'SO2', 'PM', 'CO2', 'PM']
    # path to the folder where you have you excel file from TREMOVE:
    EMISSIONS_comparisonWithMarco_v2
