...
fcity = open('O:/Integrated_assessment/SHERPA/input_atlas/city_list_fua151.txt', 'r')
...
user_reduction_folder = 'O:/Integrated_assessment/SHERPA/input_atlas/reduction_input_files/'
...
model_file = 'O:/Integrated_assessment/SHERPA/input_atlas/model_file_also_120cellsSRR.txt'
...
while True:
    ...
    if len(line) == 0:
        break
    # [model_name, ctm, pollutant, emission_cdf, concentration_cdf, source_receptor_cdf, cell_surface_cdf] = line.split('`t')
...
results_path = '../resAtlas_120cls/%s_%s_%s_%s/' % (date_tag, snap_tag, precursor_tag, area_aggregation_tag)
...
for model_name in model_dict.keys():
    ...
    reduc_area_agg_path = 'O:/Integrated_assessment/SHERPA/fua_area_cdfs/aggAreas_%s/' % (model_dict[model_name]['ctm'])
    reduc_area_all_path = 'O:/Integrated_assessment/SHERPA/fua_area_cdfs/allAreas_%s/' % (model_dict[model_name]['ctm'])
